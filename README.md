...
A local-first, single-user assistant that combines direct chat, explicit editable memory, and controlled reusable skill generation. Generated skills are validated, permission-reviewed, versioned, and executed either as bounded functions or persistent sandboxed web applications through backend-owned lifecycle, gateway, and operation-lock boundaries.
