...
- direct GitHub or Atlas traffic, provider authentication construction, secret-store access, sensitive integration environment reads, Atlas passphrase/unlock/Settings/browser-Knowledge routes, direct internal integration paths, literal undeclared or unselected operation ids, capability serialization, and browser-side integration use.
