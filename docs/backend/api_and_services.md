...
- `/settings/integrations/telegram`: sanitized bot status/disconnect plus pairing start/refresh. Pairing start accepts a write-only token and returns a one-time private-chat code.
