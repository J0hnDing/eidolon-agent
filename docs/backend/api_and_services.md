...
- `/schedules`: generated-service schedule list/detail/edit/run-now plus the read-only platform-service projection; generated-service enable/disable uses the ordinary skill update route.
