...
- `/settings/integrations/notion`: trusted status/add/replace/remove management for one write-only private-connection token and configured todo data-source ID.
