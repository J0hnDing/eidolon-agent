...
Eidolon treats a local Eidolon-Atlas instance as a trusted integration provider. Atlas remains the authority for encryption, unlock state, Bearer authentication, Knowledge invariants, and atomic writes. Generated skills never receive Atlas credentials or contact Atlas directly; they call selected registry operations through Eidolon's integration capability.
